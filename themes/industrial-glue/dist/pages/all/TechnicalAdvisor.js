...
const KNOWLEDGE_BASE = [
    {
        ...
        specs: [
            'Viscosidad: 4000-6000 cPs',
            'Sólidos: 48%',
            'Tiempo abierto: 15 min'
        ],
...
export default function TechnicalAdvisor() {
    ...
    return /*#__PURE__*/ React.createElement("div", {
        className: "fixed bottom-10 right-10 z-[100] font-sora"
        ...
        className: "absolute inset-0 bg-[#85C639] rounded-full animate-ping opacity-20"
        ...
        className: `absolute bottom-24 right-0 w-[90vw] max-w-[450px] bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border border-slate-100 transition-all duration-500 transform origin-bottom-right ${isOpen ? 'scale-100 opacity-100 translate-y-0' : 'scale-0 opacity-0 translate-y-10'}`
    }, /*#__PURE__*/ React.createElement("div", {
        className: "p-6 md:p-8 bg-[#181B1C] rounded-t-[2rem] md:rounded-t-[2.5rem] relative overflow-hidden"
    }, /*#__PURE__*/ React.createElement("div", {
        className: "absolute top-0 right-0 w-32 h-32 bg-[#2A4899]/20 blur-3xl rounded-full"
    }), /*#__PURE__*/ React.createElement("h3", {
        className: "text-white text-xl md:text-2xl font-black uppercase tracking-tighter mb-1 relative z-10"
    }, "Asesor Técnico IA"), /*#__PURE__*/ React.createElement("p", {
        className: "text-slate-400 text-[10px] font-bold uppercase tracking-widest relative z-10"
    }, "Incap Intelligent Solutions")), /*#__PURE__*/ React.createElement("div", {
        className: "p-6 md:p-10"
    }, /*#__PURE__*/ React.createElement("p", {
        className: "text-[#181B1C] font-bold text-lg mb-6 leading-tight"
    }, "¿Qué reto técnico tienes hoy?"), /*#__PURE__*/ React.createElement("div", {
        ...
        className: "w-2 h-2 bg-[#2A4899] rounded-full animate-bounce"
    }), /*#__PURE__*/ React.createElement("div", {
        className: "w-2 h-2 bg-[#2A4899] rounded-full animate-bounce delay-100"
    }), /*#__PURE__*/ React.createElement("div", {
        className: "w-2 h-2 bg-[#2A4899] rounded-full animate-bounce delay-200"
    }))), /*#__PURE__*/ React.createElement("div", {
        className: "space-y-4"
    }, results.length > 0 ? /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement("p", {
        className: "text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]"
    }, "Soluciones Recomendadas"), results.map((prod)=>/*#__PURE__*/ React.createElement("a", {
            key: prod.id,
            href: "/catalog",
            ...
            className: "font-black text-[#181B1C] uppercase text-xs group-hover:text-[#2A4899] transition-colors"
        }, prod.name), /*#__PURE__*/ React.createElement("p", {
            className: "text-[10px] text-slate-400 font-bold uppercase tracking-widest"
        }, prod.cat)), /*#__PURE__*/ React.createElement("div", {
            className: "ml-auto opacity-0 group-hover:opacity-100 transition-opacity"
        }, /*#__PURE__*/ React.createElement("svg", {
            className: "w-4 h-4 text-[#2A4899]",
            fill: "none",
            stroke: "currentColor",
            viewBox: "0 0 24 24"
        }, /*#__PURE__*/ React.createElement("path", {
            ...
            strokeWidth: "3",
            d: "M9 5l7 7-7 7"
        })))))) : query.length > 3 && !isSearching ? /*#__PURE__*/ React.createElement("div", {
        className: "text-center py-6"
    }, /*#__PURE__*/ React.createElement("p", {
        className: "text-slate-400 font-medium italic text-sm"
    }, "No encontré una coincidencia exacta, intenta describiendo los materiales...")) : null)), /*#__PURE__*/ React.createElement("div", {
        className: "p-6 md:p-8 border-t border-slate-50 text-center"
    }, /*#__PURE__*/ React.createElement("a", {
        href: "/catalog",
        className: "text-[#2A4899] font-black text-xs uppercase tracking-widest hover:text-[#181B1C] transition-colors"
