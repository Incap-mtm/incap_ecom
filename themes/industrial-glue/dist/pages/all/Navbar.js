...
export default function Navbar() {
    ...
    const familiesByIndustry = useMemo(()=>{
        ...
        for (const ind of industries){
            ...
            const products = (cat?.products?.items || []).filter((p)=>p.status === 1);
            const counts = {};
            products.forEach((p)=>{
            ...
            out[ind.id] = Object.values(groups).sort((a, b)=>b.count - a.count || a.label.localeCompare(b.label));
        }
        return out;
    }, [
        result.data
    ]);
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement("noscript", {
        dangerouslySetInnerHTML: {
            __html: `<iframe src="${GTM_SERVER_URL}/ns.html?id=${GTM_ID}" height="0" width="0" style="display:none;visibility:hidden"></iframe>`
        }
    }), /*#__PURE__*/ React.createElement("nav", {
        className: `incap-navbar ${scrolled ? 'scrolled' : ''}`
    }, /*#__PURE__*/ React.createElement("div", {
        className: "incap-navbar__inner"
    }, /*#__PURE__*/ React.createElement("a", {
        href: "/",
        className: "incap-navbar__logo group"
        ...
        className: "incap-navbar__links"
    }, /*#__PURE__*/ React.createElement("a", {
        href: "/quienes-somos",
        className: "incap-navbar__link"
    }, "Quiénes Somos"), /*#__PURE__*/ React.createElement("a", {
        href: "/fabricantes",
        className: "incap-navbar__link"
    }, "Fabricantes"), /*#__PURE__*/ React.createElement("a", {
        href: "/catalog",
        className: "incap-navbar__link"
    }, "Catálogo"), /*#__PURE__*/ React.createElement("div", {
        className: "relative",
        onMouseEnter: ()=>setDropdownOpen(true),
        onMouseLeave: ()=>setDropdownOpen(false)
    }, /*#__PURE__*/ React.createElement("a", {
        href: "#",
        className: "incap-navbar__link flex items-center gap-2"
    }, "Industrias", /*#__PURE__*/ React.createElement("svg", {
        ...
        }, ind.name), /*#__PURE__*/ React.createElement("svg", {
            width: "12",
            height: "12",
            fill: "none",
            stroke: active ? '#85C639' : '#cbd5e1',
            viewBox: "0 0 24 24",
            style: {
                flexShrink: 0
            }
        ...
        return /*#__PURE__*/ React.createElement("div", {
        ...
        }, "Familias de producto")), /*#__PURE__*/ React.createElement("div", {
            style: {
                overflowY: 'auto',
                maxHeight: '280px'
            }
        }, result.fetching && fams.length === 0 && /*#__PURE__*/ React.createElement("p", {
            style: {
                fontSize: '11px',
                color: '#94a3b8',
                padding: '8px 16px'
            }
        }, "Cargando…"), !result.fetching && fams.length === 0 && /*#__PURE__*/ React.createElement("p", {
            style: {
                fontSize: '11px',
                color: '#94a3b8',
                padding: '8px 16px'
            }
        }, "Sin familias"), fams.map(({ label, count, isGroup })=>/*#__PURE__*/ React.createElement("a", {
                key: label,
            ...
            }, label, isGroup && /*#__PURE__*/ React.createElement("span", {
                style: {
                    fontSize: '9px',
                    background: '#e0e7ff',
                    color: '#2A4899',
            ...
            }, "línea")), /*#__PURE__*/ React.createElement("span", {
                style: {
                    fontSize: '10px',
                    color: '#94a3b8',
                    fontWeight: 700
        ...
        }, "Ver todo ", activeInd.name, /*#__PURE__*/ React.createElement("svg", {
            width: "12",
            height: "12",
            fill: "none",
            stroke: "currentColor",
        ...
        className: "incap-navbar__right"
    }, /*#__PURE__*/ React.createElement("a", {
        href: "https://api.whatsapp.com/send?phone=+573002171521&text=Quiero%20m%C3%A1s%20informaci%C3%B3n",
        target: "_blank",
        rel: "noopener noreferrer",
        className: "btn-incap btn-primary-incap text-xs py-3 px-6"
    }, "Solicitar Asesoría"), /*#__PURE__*/ React.createElement("a", {
        href: "/assets/catalogo-incap.pdf",
        download: true,
    ...
    })), "Descargar Catálogo"), /*#__PURE__*/ React.createElement("button", {
        ...
        className: "incap-navbar__mobile glass-header"
    }, /*#__PURE__*/ React.createElement("div", {
        className: "pb-6"
    }, /*#__PURE__*/ React.createElement("p", {
        className: "text-[11px] font-black uppercase tracking-[0.3em] text-white/40 mb-4 px-2"
    }, "Industrias"), /*#__PURE__*/ React.createElement("div", {
        ...
        return /*#__PURE__*/ React.createElement("div", {
            ...
            className: "incap-navbar__mobile-link justify-between",
            style: {
                cursor: 'pointer'
            },
            onClick: ()=>setMobileExpandedInd(expanded ? null : ind.id)
        }, /*#__PURE__*/ React.createElement("a", {
            href: ind.href,
            className: "flex-1 text-white",
            onClick: (e)=>e.stopPropagation()
        }, ind.name), /*#__PURE__*/ React.createElement("svg", {
            className: `h-4 w-4 text-[#85C639] flex-shrink-0 transition-transform ${expanded ? 'rotate-180' : ''}`,
            fill: "none",
            stroke: "currentColor",
            viewBox: "0 0 24 24"
        }, /*#__PURE__*/ React.createElement("path", {
            ...
            className: "pl-4 pb-2"
        }, fams.length === 0 && /*#__PURE__*/ React.createElement("p", {
            className: "text-[11px] text-white/40 py-2"
        }, "Sin familias"), fams.map(({ label, count })=>/*#__PURE__*/ React.createElement("a", {
                key: label,
    ...
    }, "Quiénes Somos", /*#__PURE__*/ React.createElement("svg", {
        ...
        href: "/fabricantes",
        className: "incap-navbar__mobile-link"
    }, "Fabricantes", /*#__PURE__*/ React.createElement("svg", {
        className: "h-4 w-4 text-[#85C639] flex-shrink-0",
        fill: "none",
        stroke: "currentColor",
        viewBox: "0 0 24 24"
        ...
        href: "/catalog",
        className: "incap-navbar__mobile-link"
    }, "Catálogo", /*#__PURE__*/ React.createElement("svg", {
        className: "h-4 w-4 text-[#85C639] flex-shrink-0",
        fill: "none",
        stroke: "currentColor",
        viewBox: "0 0 24 24"
