...
export default function Navbar() {
    ...
    const familiesByIndustry = useMemo(()=>{
        ...
        for (const ind of industries){
            ...
            out[ind.id] = Object.entries(counts).sort((a, b)=>b[1] - a[1] || a[0].localeCompare(b[0])).map(([family, count])=>({
                    family,
                    count
                }));
        }
    ...
    return /*#__PURE__*/ React.createElement("nav", {
        ...
        href: "/fabricantes",
        className: "incap-navbar__link"
    }, "Fabricantes"), /*#__PURE__*/ React.createElement("div", {
        className: "relative",
        ...
        return /*#__PURE__*/ React.createElement("div", {
        ...
        }, "Sin familias"), fams.map(({ family, count })=>/*#__PURE__*/ React.createElement("a", {
                key: family,
            ...
            }, /*#__PURE__*/ React.createElement("span", null, family), /*#__PURE__*/ React.createElement("span", {
                style: {
                    fontSize: '10px',
                    color: '#94a3b8',
                    fontWeight: 700
        ...
        href: "/distribuidores",
        className: "incap-navbar__link"
    }, "Distribuidores")), /*#__PURE__*/ React.createElement("div", {
