...
export default function Navbar() {
    ...
    const catalogUrl = ((_b = (_a = catalogResult.data) === null || _a === void 0 ? void 0 : _a.setting) === null || _b === void 0 ? void 0 : _b.catalogUrl) || '/assets/catalogo-incap.pdf';
    const catalogButtonText = ((_d = (_c = catalogResult.data) === null || _c === void 0 ? void 0 : _c.setting) === null || _d === void 0 ? void 0 : _d.catalogButtonText) || 'Descargar Catálogo';
        ...
        React.createElement("nav", { className: `incap-navbar ${scrolled ? 'scrolled' : ''}` },
            React.createElement("div", { className: "incap-navbar__inner" },
                ...
                React.createElement("div", { className: "incap-navbar__links" },
                    ...
                    React.createElement("a", { href: "/catalog", className: "incap-navbar__link" }, "Cat\u00E1logo"),
                    React.createElement("a", { href: "/blog", className: "incap-navbar__link" }, "Blog"),
                                ...
                                React.createElement("div", { style: { width: '200px', flexShrink: 0, borderRight: '1px solid #e2e8f0', padding: '8px 0' } }, industries.map((ind) => {
                                    ...
                                    return (React.createElement("div", { key: ind.id, onMouseEnter: () => setHoveredInd(ind.id), style: {
                                        ...
                                        React.createElement("div", { style: {
                                            ...
                                            React.createElement("img", { src: ind.icon, style: { width: '18px', height: '18px', objectFit: 'contain', filter: 'brightness(0) invert(1)' }, alt: "" })),
                ...
                React.createElement("div", { className: "incap-navbar__right" },
                    ...
                    React.createElement("button", { type: "button", onClick: () => setShowCatalogModal(true), className: "incap-catalog-link", style: { background: 'none', border: 'none', cursor: 'pointer', padding: 0 } },
            ...
            mobileOpen && (React.createElement("div", { className: "incap-navbar__mobile glass-header" },
                    ...
                    React.createElement("div", { className: "grid grid-cols-1 gap-1" }, industries.map((ind) => {
                        ...
                        return (React.createElement("div", { key: ind.id },
                            ...
                            expanded && (React.createElement("div", { className: "pl-4 pb-2" },
                                ...
                                fams.map(({ label, count }) => (React.createElement("a", { key: label, href: `${ind.href}?familia=${encodeURIComponent(label)}`, className: "block text-[12px] text-white/80 hover:text-[#85C639] py-2 font-sora uppercase tracking-wide" },
                                    label,
                                    " ",
                ...
                React.createElement("a", { href: "/fabricantes", className: "incap-navbar__mobile-link" },
                    ...
                    React.createElement("svg", { className: "h-4 w-4 text-[#85C639] flex-shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                        React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M9 5l7 7-7 7" }))),
                React.createElement("a", { href: "/catalog", className: "incap-navbar__mobile-link" },
                    "Cat\u00E1logo",
                    React.createElement("svg", { className: "h-4 w-4 text-[#85C639] flex-shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                        React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M9 5l7 7-7 7" }))),
                React.createElement("a", { href: "/blog", className: "incap-navbar__mobile-link" },
                    "Blog",
                    React.createElement("svg", { className: "h-4 w-4 text-[#85C639] flex-shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                        React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M9 5l7 7-7 7" }))),
                React.createElement("button", { type: "button", onClick: () => { setMobileOpen(false); setShowCatalogModal(true); }, className: "incap-navbar__mobile-link", style: { background: 'none', border: 'none', cursor: 'pointer', width: '100%' } },
                    catalogButtonText,
                    React.createElement("svg", { className: "h-4 w-4 text-[#85C639] flex-shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                        React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5 5-5M12 3v12" }))),
            ...
            showCatalogModal && (React.createElement(LeadDownloadModal, { context: { kind: 'catalogo', downloadUrl: catalogUrl }, title: catalogButtonText, onClose: () => setShowCatalogModal(false) })))));
}
export const layout = {
    areaId: 'headerTop',
    sortOrder: 1
