...
export default function WhatsAppCTA({ product }) {
    ...
    return (React.createElement("div", { className: "py-8 border-t border-slate-100", style: { position: 'sticky', top: '120px' } },
        React.createElement("div", { className: "bg-[#181B1C] rounded-3xl p-6 shadow-xl shadow-slate-900/20" },
            ...
            React.createElement("a", { href: `https://wa.me/${WHATSAPP_NUMBER}?text=${waMessage}`, target: "_blank", rel: "noopener noreferrer", className: "w-full flex items-center justify-center gap-3 py-4 bg-[#85C639] text-[#181B1C] rounded-xl font-black text-xs uppercase tracking-widest font-sora hover:bg-[#74b030] transition-all duration-200 hover:scale-[1.02]" },
