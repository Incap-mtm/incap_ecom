        ...
        React.createElement("div", { className: "max-w-[1536px] mx-auto px-6 sm:px-8 lg:px-12" },
            React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32" },
                React.createElement("div", { className: `${reveal.className}` },
                    ...
                    React.createElement("p", { className: "text-xl md:text-2xl text-[#2A4899]/70 font-inter font-medium leading-relaxed mb-8 max-w-xl" }, "Desde 1969, entendemos que detr\u00E1s de cada adhesivo hay una familia y una f\u00E1brica que compite a nivel global.")),
                React.createElement("div", { className: `relative ${reveal.className} reveal-stagger-2 active mt-10 lg:mt-0` },
                    React.createElement("div", { className: "rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] transform rotate-3 hover:rotate-0 transition-transform duration-700 w-full relative z-0" },
                        React.createElement("img", { src: "/images/sections/Uniendo_Legado_Home.png", className: "w-full h-auto object-cover", alt: "INCAP Mascota Legacy" })),
            ...
            React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12" }, [
                ...
                React.createElement("p", { className: "text-slate-500 font-inter text-xs md:text-sm leading-relaxed font-medium" }, p.d))))))));
}
export const layout = {
    areaId: 'content',
    sortOrder: 10
