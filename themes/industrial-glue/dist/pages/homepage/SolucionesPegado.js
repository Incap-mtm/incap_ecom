...
export default function SolucionesPegado() {
    ...
    return /*#__PURE__*/ React.createElement("section", {
        className: `bg-[#181B1C] py-24 px-4 sm:px-6 lg:px-8 ${reveal.className}`,
        ref: reveal.ref
        ...
        className: "text-[#85C639] font-black text-[11px] uppercase tracking-[0.4em] font-sora mb-4"
    }, "Guía técnica de aplicación"), /*#__PURE__*/ React.createElement("h2", {
        className: "text-4xl md:text-6xl font-black text-white leading-tight uppercase font-sora"
    }, "ENCUENTRA LA SOLUCIÓN", /*#__PURE__*/ React.createElement("br", null), /*#__PURE__*/ React.createElement("span", {
        className: "text-[#2A4899]"
    }, "IDEAL PARA TU SECTOR")), /*#__PURE__*/ React.createElement("div", {
        className: "w-24 h-2 bg-[#85C639] mt-6 mx-auto"
    }), /*#__PURE__*/ React.createElement("p", {
        className: "text-slate-400 text-sm md:text-base font-inter font-light mt-6 max-w-2xl mx-auto leading-relaxed"
    }, "Fabricamos soluciones específicas para optimizar tus procesos productivos. Identifica el icono de tu sector para elegir el adhesivo correcto.")), /*#__PURE__*/ React.createElement("div", {
        className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto"
    }, solutions.map((sol, i)=>/*#__PURE__*/ React.createElement("div", {
            key: i,
            ...
            className: "w-16 h-16 mb-4 bg-[#2A4899] rounded-2xl flex items-center justify-center flex-shrink-0"
            ...
            className: "text-white font-black text-sm uppercase tracking-wide font-sora mb-2 leading-tight"
        }, sol.name), /*#__PURE__*/ React.createElement("p", {
            className: "text-slate-400 text-xs font-inter leading-relaxed"
        }, sol.description))))));
}
export const layout = {
    areaId: 'content',
