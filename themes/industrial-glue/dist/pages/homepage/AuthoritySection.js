...
export default function AuthoritySection() {
    ...
    return (React.createElement("section", { className: "py-24 bg-white border-y border-slate-100 overflow-hidden" },
        ...
        React.createElement("div", { className: "relative group" },
            ...
            React.createElement("div", { className: "flex animate-marquee whitespace-nowrap items-center py-4 grayscale hover:grayscale-0 transition-all duration-1000 opacity-40 hover:opacity-100" }, [...logos, ...logos].map((logo, i) => (React.createElement("img", { key: i, src: logo, loading: "lazy", className: "h-10 w-auto object-contain flex-shrink-0 transition-transform hover:scale-110", style: { marginRight: '80px' }, alt: "Partner Logo" })))))));
}
export const layout = {
    areaId: 'content',
    sortOrder: 15
