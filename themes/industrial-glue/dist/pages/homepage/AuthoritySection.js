...
export default function AuthoritySection() {
    ...
    return (React.createElement("section", { className: "py-24 bg-white border-y border-slate-100 overflow-hidden" },
        ...
        React.createElement("div", { className: "relative group" },
            ...
            React.createElement("div", { className: "flex animate-marquee whitespace-nowrap items-center py-4 grayscale hover:grayscale-0 transition-all duration-1000 opacity-40 hover:opacity-100 gap-[80px]" }, [...logos, ...logos, ...logos, ...logos].map((logo, i) => (React.createElement("img", { key: i, src: logo, className: "h-10 w-auto object-contain flex-shrink-0 transition-transform hover:scale-110", alt: "Partner Logo" })))))));
}
export const layout = {
    areaId: 'content',
    sortOrder: 15
