...
export default function Hero() {
    ...
    return /*#__PURE__*/ React.createElement("section", {
        ...
        className: "relative z-10 max-w-[1536px] mx-auto px-6 sm:px-8 lg:px-12 w-full pt-32 pb-[9.6rem]"
    }, /*#__PURE__*/ React.createElement("div", {
        ...
        className: "text-[3.15rem] md:text-[4.725rem] lg:text-[9.45rem] font-black text-white leading-[0.8] mb-12 font-sora tracking-tighter uppercase reveal reveal-stagger-2 active"
        ...
        className: "text-[1.05rem] md:text-[1.3125rem] text-slate-400 mb-8 max-w-3xl font-inter font-light leading-relaxed reveal reveal-stagger-3 active"
