    ...
    return (React.createElement("section", { className: "relative w-full overflow-hidden bg-[#181B1C]", style: { height: '90vh', minHeight: '560px' } },
        slides.map((slide, i) => (React.createElement("div", { key: i, "aria-hidden": i !== current, className: "absolute inset-0 transition-opacity duration-700", style: { opacity: i === current ? 1 : 0, zIndex: i === current ? 1 : 0 } },
            React.createElement("picture", null,
                React.createElement("source", { media: "(max-width: 768px)", srcSet: slide.mobile, type: "image/webp" }),
                React.createElement("source", { media: "(max-width: 768px)", srcSet: slide.mobileFallback }),
                React.createElement("source", { srcSet: slide.desk, type: "image/webp" }),
                React.createElement("img", { src: slide.deskFallback, alt: slide.alt, className: "w-full h-full object-cover", loading: i === 0 ? 'eager' : 'lazy', fetchPriority: i === 0 ? 'high' : 'auto' }))))),
