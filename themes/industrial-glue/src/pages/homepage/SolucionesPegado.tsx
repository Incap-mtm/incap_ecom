...
const solutions = [
  ...
  {
    icon: '/images/icons/icono_Espuma.png',
    name: 'Colchones',
  ...
  {
    icon: '/images/icons/Icono_Multiusos.png',
...
export default function SolucionesPegado() {
  ...
  return (
    <section className={`bg-[#181B1C] py-24 px-4 sm:px-6 lg:px-8 ${reveal.className}`} ref={reveal.ref}>
      <div className="w-full max-w-[1920px] mx-auto">

        {/* Header */}
        <div className="text-center mb-16">
          <p className="text-[#85C639] font-black text-[11px] uppercase tracking-[0.4em] font-sora mb-4">
            Guía técnica de aplicación
          </p>
          <h2 className="text-4xl md:text-6xl font-black text-white leading-tight uppercase font-sora">
            ENCUENTRA LA SOLUCIÓN<br />
            <span className="text-[#2A4899]">IDEAL PARA TU SECTOR</span>
          </h2>
          <div className="w-24 h-2 bg-[#85C639] mt-6 mx-auto" />
          <p className="text-slate-400 text-sm md:text-base font-inter font-light mt-6 max-w-2xl mx-auto leading-relaxed">
            Fabricamos soluciones específicas para optimizar tus procesos productivos. Identifica el icono de tu sector para elegir el adhesivo correcto.
          </p>
        </div>
          ...
          {solutions.map((sol, i) => (
            ...
            >
              <div className="w-16 h-16 mb-4 bg-[#2A4899] rounded-2xl flex items-center justify-center flex-shrink-0">
                <img src={sol.icon} alt={sol.name} loading="lazy" style={{ width: '36px', height: '36px', objectFit: 'contain', display: 'block' }} />
              </div>
