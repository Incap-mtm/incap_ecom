...
export default function Head() {
  ...
  return (
    <>
      {/* Google Tag Manager (server-side) — loader del contenedor web apuntando
          a nuestro servidor de tagging (no a googletagmanager.com). Lo más alto
          posible del <head>. Config en utils/gtm.ts. */}
      <script dangerouslySetInnerHTML={{ __html:
        `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='${GTM_SERVER_URL}/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','${GTM_ID}');`
      }} />
