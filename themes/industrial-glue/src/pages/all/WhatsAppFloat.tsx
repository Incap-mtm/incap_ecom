...
export default function WhatsAppFloat({ setting }: Props) {
  const number = setting?.storeWhatsappNumber ?? '573002171521';
  ...
  return (
    <a
      ...
      onMouseEnter={(e) => {
        ...
        (e.currentTarget as HTMLElement).style.boxShadow = '0 10px 28px rgba(37,211,102,0.6)';
      }}
      onMouseLeave={(e) => {
