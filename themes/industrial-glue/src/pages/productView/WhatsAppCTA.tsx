...
export default function WhatsAppCTA({ product }: ProductProps) {
  ...
  const techMessage = encodeURIComponent(
    `Hola INCAP! Necesito soporte técnico sobre: *${productName || 'este producto'}*`
  );

  return (
    <div className="py-8 border-t border-slate-100" style={{ position: 'sticky', top: '120px' }}>
      <div className="bg-[#181B1C] rounded-3xl p-6 shadow-xl shadow-slate-900/20">

        {/* Header */}
        <div className="mb-6">
          <p className="text-[9px] font-black text-[#85C639] uppercase tracking-[0.3em] font-sora mb-1">
            Solicitar cotización
          </p>
          <p className="text-white font-black text-lg font-sora uppercase tracking-tight leading-tight">
            Respuesta en<br />
            <span className="text-[#85C639] italic">menos de 24 h</span>
          </p>
        </div>
        ...
        <p className="text-[10px] text-white/30 text-center mt-4 font-inter">
