...
interface ProductProps {
  product?: {
    name?: string;
    sku?: string;
    selectedVariant?: { name?: string; sku?: string };
  };
}
  ...
  return (
    <div className="mt-8 pt-6 border-t border-slate-100">
      <a
        ...
        className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-lg rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg shadow-green-900/20"
      >
      ...
      <p className="text-center text-xs text-slate-400 mt-2">
        Un asesor técnico te responde en menos de 24 horas hábiles
      </p>
    </div>
  );
}
