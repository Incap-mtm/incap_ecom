...
export default async function blogIndex(request, response) {
    ...
    try {
        const value = JSON.stringify({ posts: body.posts, tags: (_a = body.tags) !== null && _a !== void 0 ? _a : [] });
        await pool.query(`INSERT INTO setting (name, value, is_json)
       VALUES ('blog_index', $1, true)
       ON CONFLICT (name) DO UPDATE SET value = EXCLUDED.value, is_json = true`, [value]);
...
//# sourceMappingURL=%5BbodyParser%5DblogIndex.js.map