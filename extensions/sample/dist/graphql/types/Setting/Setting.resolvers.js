...
export default {
    ...
    Query: {
        sizeOptions: async (_, __, { pool: ctxPool }) => {
            ...
            const { rows } = await p.query(`SELECT attribute_option_id AS id, option_text AS text
        ...
        homeBlogPosts: async (_, { limit }) => {
            ...
            const posts = Array.isArray(data === null || data === void 0 ? void 0 : data.posts) ? data.posts : [];
