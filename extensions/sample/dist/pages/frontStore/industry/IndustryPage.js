...
export default function IndustryPage() {
    ...
    return (React.createElement("div", { className: "min-h-screen animate-fadeIn bg-white font-sora -mt-[124px]" },
        React.createElement("div", { className: "relative overflow-hidden bg-[#181B1C] pt-[124px]" },
            React.createElement("img", { src: data.heroImage, className: "w-full h-auto block opacity-60", alt: data.name }),
            React.createElement("div", { className: "absolute inset-0 bg-gradient-to-t from-[#181B1C] via-[#181B1C]/20 to-transparent pointer-events-none" }),
            React.createElement("div", { className: "absolute inset-x-0 top-0 h-48 bg-gradient-to-b from-[#181B1C]/80 to-transparent z-10 pointer-events-none" }),
            React.createElement("div", { className: "absolute inset-x-0 bottom-0 pb-10 md:pb-16 z-20" },
                React.createElement("div", { className: "max-w-[1536px] mx-auto w-full px-4 sm:px-6 lg:px-8" },
