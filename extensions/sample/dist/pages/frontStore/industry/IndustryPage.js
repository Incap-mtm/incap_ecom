...
export default function IndustryPage() {
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ...
        className: "text-3xl sm:text-5xl md:text-6xl font-black text-[#181B1C] font-sora mb-10 md:mb-24 uppercase text-center tracking-tighter"
        ...
        className: "grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12"
            ...
            className: "h-52 md:h-80 overflow-hidden bg-slate-100"
