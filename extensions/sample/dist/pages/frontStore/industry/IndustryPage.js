        ...
        React.createElement("section", { className: "py-16 md:py-32 bg-slate-50" },
            React.createElement("div", { className: "max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8" },
                ...
                result.fetching ? (React.createElement("div", { className: "text-center py-20 text-slate-400" }, "Cargando portafolio...")) : filteredProducts.length > 0 ? (React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12" }, filteredProducts.map((prod) => {
                    var _a, _b, _c, _d;
                    return (React.createElement("a", { href: (_a = prod.url) !== null && _a !== void 0 ? _a : `/product/${prod.uuid}`, key: prod.productId, className: "bg-white p-0 rounded-[2rem] md:rounded-[2.5rem] shadow-xl border border-slate-100 hover:shadow-2xl transition-all cursor-pointer group overflow-hidden block" },
                        React.createElement("div", { className: "h-52 md:h-72 overflow-hidden bg-white flex items-center justify-center p-4" }, ((_b = prod.image) === null || _b === void 0 ? void 0 : _b.url) ? (React.createElement("img", { src: prod.image.url, className: "w-full h-full object-contain group-hover:scale-105 transition-transform duration-700", alt: prod.name })) : (React.createElement("div", { className: "w-full h-full flex items-center justify-center text-slate-300 font-sora font-black uppercase tracking-widest text-base md:text-xl" }, "Sin Imagen"))),
                        React.createElement("div", { className: "p-6 md:p-12" },
                            ...
                            React.createElement("div", { className: "inline-block px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-lg text-[10px] font-black text-slate-400 mb-6 md:mb-10 uppercase tracking-[0.3em]" }, ((_d = (_c = prod.price) === null || _c === void 0 ? void 0 : _c.regular) === null || _d === void 0 ? void 0 : _d.text) || 'Consultar'),
