...
export default function IndustryPage() {
    ...
    const filteredByFamily = activeFamily ? realProducts.filter((p)=>getFamily(p.name) === activeFamily) : realProducts;
    ...
    return /*#__PURE__*/ React.createElement("div", {
    ...
    }, "Portafolio Técnico"), !result.fetching && realProducts.length > 0 && /*#__PURE__*/ React.createElement("div", {
        style: {
            marginBottom: '40px'
        }
    }, /*#__PURE__*/ React.createElement("div", {
        ...
        className: "grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12"
            ...
            key: prod.productId,
            className: "bg-white p-0 rounded-[2rem] md:rounded-[2.5rem] shadow-xl border border-slate-100 hover:shadow-2xl transition-all cursor-pointer group overflow-hidden block"
        }, /*#__PURE__*/ React.createElement("div", {
            className: "h-52 md:h-72 overflow-hidden bg-white flex items-center justify-center p-4"
            ...
            className: "text-[#2A4899] font-black text-[10px] uppercase tracking-[0.4em] mb-3 block"
        }, "Especializado"), /*#__PURE__*/ React.createElement("h3", {
            className: "text-xl md:text-3xl font-black mb-4 md:mb-6 font-sora text-[#181B1C] group-hover:text-[#2A4899] transition-colors uppercase tracking-tight leading-none"
        }, prod.name), /*#__PURE__*/ React.createElement("div", {
            className: "inline-block px-3 py-1.5 md:px-4 md:py-2 bg-slate-50 rounded-lg text-[10px] font-black text-slate-400 mb-6 md:mb-10 uppercase tracking-[0.3em]"
        }, prod.price?.regular?.text || 'Consultar'), /*#__PURE__*/ React.createElement("div", {
            className: "flex items-center justify-between"
        }, /*#__PURE__*/ React.createElement("span", {
            className: "text-[#2A4899] font-black font-sora text-xs md:text-sm uppercase tracking-widest"
        }, "Ver Ficha Técnica"), /*#__PURE__*/ React.createElement("div", {
            className: "w-10 h-10 md:w-14 md:h-14 rounded-full border-2 border-slate-100 flex items-center justify-center group-hover:bg-[#2A4899] group-hover:text-white transition-all duration-500"
        }, "→")))))) : /*#__PURE__*/ React.createElement("div", {
