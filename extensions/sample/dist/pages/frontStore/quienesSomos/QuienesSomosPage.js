...
export default function QuienesSomosPage() {
    ...
    return (React.createElement("div", { style: { fontFamily: 'Sora, Inter, sans-serif', background: '#f8fafc', color: '#181B1C' } },
        React.createElement("section", { style: { background: 'linear-gradient(135deg, #2A4899 0%, #1e3576 100%)', position: 'relative', overflow: 'hidden' } },
            ...
            React.createElement("div", { style: { ...S.inner, padding: '5rem 2rem 3rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'center', position: 'relative' } },
                React.createElement("div", null,
                    ...
                    React.createElement("p", { style: { fontSize: '16px', color: 'rgba(255,255,255,0.75)', lineHeight: 1.75, margin: '0 0 2rem', fontFamily: 'Inter, sans-serif', maxWidth: '520px' } }, c.hero.subtitulo),
            ...
            React.createElement("div", { style: { ...S.inner, padding: '0 2rem 3rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' } }, c.hero.stats.map((st, i) => (React.createElement("div", { key: i, style: { background: 'rgba(255,255,255,0.12)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '50px', padding: '14px 20px', textAlign: 'center' } },
                React.createElement("div", { style: { fontSize: 'clamp(1.5rem, 3vw, 2.25rem)', fontWeight: 900, color: '#fff', fontFamily: 'Sora, sans-serif', lineHeight: 1 } }, st.valor),
                React.createElement("div", { style: { fontSize: '10px', color: 'rgba(255,255,255,0.65)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em', marginTop: '4px', fontFamily: 'Inter, sans-serif' } }, st.label)))))),
        React.createElement("section", { style: { background: '#fff', ...S.sectionPad } },
            React.createElement("div", { style: { ...S.inner, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'start' } },
                React.createElement("div", null,
                    ...
                    React.createElement("h2", { style: S.h2 }, c.somos.titulo),
                    React.createElement("p", { style: { ...S.body, color: '#64748b', fontSize: '13px', marginBottom: '1.25rem', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 700 } }, c.somos.subtitulo),
                    React.createElement("p", { style: S.body }, c.somos.intro)),
                React.createElement("div", { style: { display: 'grid', gap: '1.25rem' } }, c.somos.marcas.map((m, i) => (React.createElement("div", { key: i, style: { ...S.card, borderTop: `4px solid ${m.color}`, padding: '0' } },
                    React.createElement("div", { style: { height: '6px', background: m.color, borderRadius: '16px 16px 0 0' } }),
                    React.createElement("div", { style: { padding: '1.5rem' } },
                        React.createElement("span", { style: { fontSize: '9px', fontWeight: 700, color: m.color, letterSpacing: '0.25em', textTransform: 'uppercase', display: 'block', marginBottom: '10px' } }, m.tag),
                        m.imagen && React.createElement("img", { src: m.imagen, alt: m.tag, style: { height: '40px', objectFit: 'contain', marginBottom: '10px' } }),
                        React.createElement("p", { style: S.bodyMuted }, m.descripcion)))))))),
        React.createElement("section", { style: { background: '#f1f5f9', ...S.sectionPad } },
            React.createElement("div", { style: S.inner },
                React.createElement("div", { style: { textAlign: 'center', marginBottom: '2.5rem' } },
                    React.createElement("span", { style: S.kicker }, "Prop\u00F3sito"),
                    React.createElement("h2", { style: S.h2 }, "Misi\u00F3n y Visi\u00F3n")),
                React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' } },
                    React.createElement("div", { style: { background: '#2A4899', borderRadius: '16px', padding: '2.25rem' } },
                        React.createElement("span", { style: { ...S.kicker, color: '#85C639', marginBottom: '14px' } }, "Misi\u00F3n"),
                        React.createElement("p", { style: { fontSize: '15px', color: 'rgba(255,255,255,0.88)', lineHeight: 1.8, margin: 0, fontFamily: 'Inter, sans-serif' } }, c.misionVision.mision)),
                    React.createElement("div", { style: { background: '#181B1C', borderRadius: '16px', padding: '2.25rem' } },
                        React.createElement("span", { style: { ...S.kicker, color: '#85C639', marginBottom: '14px' } }, "Visi\u00F3n"),
                        React.createElement("p", { style: { fontSize: '15px', color: 'rgba(255,255,255,0.75)', lineHeight: 1.8, margin: 0, fontFamily: 'Inter, sans-serif' } }, c.misionVision.vision))))),
        React.createElement("section", { style: { background: '#fff', ...S.sectionPad } },
            React.createElement("div", { style: S.inner },
                React.createElement("div", { style: { textAlign: 'center', marginBottom: '2.5rem' } },
                    React.createElement("span", { style: S.kicker }, c.pilares.kicker),
                    React.createElement("h2", { style: S.h2 }, c.pilares.titulo)),
                React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem' } }, c.pilares.items.map((p, i) => {
                    var _a;
                    return (React.createElement("div", { key: i, style: { ...S.card, textAlign: 'center' } },
        ...
        React.createElement("section", { style: { background: '#f1f5f9', ...S.sectionPad } },
            React.createElement("div", { style: S.inner },
                React.createElement("div", { style: { textAlign: 'center', marginBottom: '2.5rem' } },
                    React.createElement("span", { style: S.kicker }, c.marcasGrupo.kicker),
                    React.createElement("h2", { style: S.h2 }, c.marcasGrupo.titulo)),
                React.createElement("div", { style: { display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '2.5rem' } }, c.marcasGrupo.logos.map((logo) => (React.createElement("img", { key: logo.nombre, src: logo.src, alt: logo.nombre, style: { height: '44px', width: 'auto', objectFit: 'contain', filter: 'grayscale(0.6)', opacity: 0.8, transition: 'filter 0.25s, opacity 0.25s' }, onMouseEnter: e => { e.currentTarget.style.filter = 'grayscale(0)'; e.currentTarget.style.opacity = '1'; }, onMouseLeave: e => { e.currentTarget.style.filter = 'grayscale(0.6)'; e.currentTarget.style.opacity = '0.8'; } })))))),
        React.createElement("section", { style: { background: '#fff', ...S.sectionPad } },
            React.createElement("div", { style: S.inner },
                React.createElement("div", { style: { textAlign: 'center', marginBottom: '2.5rem' } },
                    React.createElement("span", { style: S.kicker }, c.industrias.kicker),
                    React.createElement("h2", { style: S.h2 }, c.industrias.titulo)),
                React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.25rem', marginBottom: '2rem' } }, c.industrias.items.map((ind, i) => (React.createElement("a", { key: i, href: ind.href, style: { display: 'flex', flexDirection: 'column', background: '#2A4899', borderRadius: '16px', padding: '1.75rem', textDecoration: 'none', transition: 'transform 0.2s, box-shadow 0.2s', boxShadow: '0 2px 12px rgba(42,72,153,0.15)' }, onMouseEnter: e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 12px 32px rgba(42,72,153,0.28)'; }, onMouseLeave: e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 2px 12px rgba(42,72,153,0.15)'; } },
                    React.createElement("div", { style: { width: '52px', height: '52px', borderRadius: '12px', background: 'rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' } },
                        React.createElement("img", { src: ind.icon, alt: ind.nombre, style: { width: '32px', height: '32px', objectFit: 'contain', filter: 'brightness(10)' } })),
                    ...
                    React.createElement("p", { style: { fontSize: '12px', color: 'rgba(255,255,255,0.72)', lineHeight: 1.65, margin: '0 0 1.25rem', fontFamily: 'Inter, sans-serif', flex: 1 } }, ind.descripcion),
                    React.createElement("span", { style: { fontSize: '10px', fontWeight: 900, color: '#85C639', textTransform: 'uppercase', letterSpacing: '0.12em' } }, "Ver soluciones \u2192"))))),
            ...
            React.createElement("div", { style: S.inner },
                React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'center', marginBottom: '3rem' } },
                    ...
                    React.createElement("div", null,
                        ...
                        c.mascota.parrafos.map((p, i) => (React.createElement("p", { key: i, style: { fontSize: '15px', color: 'rgba(255,255,255,0.8)', lineHeight: 1.8, fontFamily: 'Inter, sans-serif', margin: '0 0 1rem' } }, p))))),
                React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem' } }, c.mascota.cards.map((card, i) => (React.createElement("div", { key: i, style: {
                    ...
                    React.createElement("h3", { style: { fontSize: '0.9rem', fontWeight: 900, color: card.destacado ? '#181B1C' : '#85C639', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '0 0 0.625rem' } }, card.titulo),
                    React.createElement("p", { style: { fontSize: '13px', color: card.destacado ? '#181B1C' : 'rgba(255,255,255,0.75)', lineHeight: 1.7, margin: 0, fontFamily: 'Inter, sans-serif' } }, card.descripcion))))))),
        React.createElement("section", { style: { background: '#fff', ...S.sectionPad } },
            React.createElement("div", { style: S.inner },
                React.createElement("span", { style: S.kicker }, c.fabricacion.kicker),
                React.createElement("h2", { style: { ...S.h2, maxWidth: '700px', marginBottom: '1.5rem' } },
                    "Fabricamos la mayor\u00EDa de lo que vendemos. Y ",
                    React.createElement("span", { style: S.green }, "lo dise\u00F1amos nosotros"),
                    "."),
                c.fabricacion.parrafos.map((p, i) => (React.createElement("p", { key: i, style: { ...S.body, maxWidth: '780px' } }, p))),
                React.createElement("div", { style: { ...S.card, marginTop: '2.5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', alignItems: 'center' } },
                    React.createElement("div", null,
                        React.createElement("p", { style: { ...S.bodyMuted, fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '10px', color: '#94a3b8' } }, c.fabricacion.caso.titulo),
                    ...
                    (c.fabricacion.caso.videoPlaceholder || !c.fabricacion.caso.videoUrl) && (React.createElement("div", { style: { aspectRatio: '16/9', background: '#f1f5f9', border: '2px dashed #cbd5e1', borderRadius: '12px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px' } },
                        ...
                        React.createElement("span", { style: { fontSize: '11px', color: '#cbd5e1', fontFamily: 'Inter, sans-serif' } }, "Pr\u00F3ximamente")))))),
        React.createElement("section", { style: { background: '#f1f5f9', ...S.sectionPad } },
            React.createElement("div", { style: S.inner },
        ...
        React.createElement("section", { style: { background: '#1e2a5e', ...S.sectionPad } },
            React.createElement("div", { style: { ...S.inner, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'center' } },
                React.createElement("div", null,
                    ...
                    React.createElement("p", { style: { fontSize: '15px', color: 'rgba(255,255,255,0.75)', lineHeight: 1.8, fontFamily: 'Inter, sans-serif', margin: '0 0 1.75rem' } }, c.alianzas.intro),
        ...
        React.createElement("section", { style: { background: '#fff', ...S.sectionPad } },
            React.createElement("div", { style: { ...S.inner, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'center' } },
                React.createElement("div", null,
                    ...
                    React.createElement("div", { style: { display: 'grid', gap: '1rem', marginTop: '1.5rem' } }, c.innovacion.features.map((f, i) => (React.createElement("div", { key: i, style: { display: 'flex', gap: '1rem', alignItems: 'flex-start' } },
                        React.createElement("div", { style: { width: '44px', height: '44px', borderRadius: '10px', background: '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 } },
                            React.createElement("img", { src: f.icon, alt: f.titulo, style: { width: '28px', height: '28px', objectFit: 'contain' } })),
                        React.createElement("div", null,
                            React.createElement("div", { style: { fontSize: '13px', fontWeight: 900, color: '#85C639', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '3px' } }, f.titulo),
                            React.createElement("p", { style: { ...S.bodyMuted, fontSize: '12px' } }, f.descripcion))))))),
                React.createElement("div", { style: { display: 'flex', justifyContent: 'center' } },
                    React.createElement("img", { src: c.innovacion.imagen, alt: "CAP con Bidon Box INCAP", style: { maxHeight: '460px', maxWidth: '100%', objectFit: 'contain', filter: 'drop-shadow(0 20px 40px rgba(42,72,153,0.2))' } })))),
        React.createElement("section", { style: { background: '#181B1C', ...S.sectionPad } },
            React.createElement("div", { style: { ...S.inner, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'center' } },
                React.createElement("div", null,
                    React.createElement("h2", { style: { fontSize: 'clamp(2.5rem, 6vw, 5rem)', fontWeight: 900, color: '#fff', margin: '0 0 0.5rem', lineHeight: 1, letterSpacing: '-0.02em', fontFamily: 'Sora, sans-serif' } },
                        "\u00BFFallas de ",
                        React.createElement("span", { style: S.green }, "PEGUE?")),
                    React.createElement("p", { style: { fontSize: '16px', color: 'rgba(255,255,255,0.6)', fontFamily: 'Inter, sans-serif', margin: '0 0 2rem', lineHeight: 1.6 } }, c.fallasCta.subtitulo),
                    c.fallasCta.parrafos.map((p, i) => (React.createElement("p", { key: i, style: { fontSize: '14px', color: 'rgba(255,255,255,0.7)', lineHeight: 1.8, fontFamily: 'Inter, sans-serif', margin: '0 0 1rem' } }, p))),
                    React.createElement("a", { href: waHref, target: "_blank", rel: "noopener noreferrer", style: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#85C639', color: '#181B1C', padding: '16px 32px', borderRadius: '50px', fontSize: '12px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.15em', textDecoration: 'none', marginTop: '1rem' } },
                        c.fallasCta.boton.texto,
                        " \u2192")),
                React.createElement("div", { style: { display: 'flex', justifyContent: 'center', opacity: 0.15 } },
                    React.createElement("img", { src: c.hero.imagen, alt: "", "aria-hidden": "true", style: { maxHeight: '360px', maxWidth: '100%', objectFit: 'contain' } }))))));
}
export const layout = {
    areaId: 'content',
    sortOrder: 1,
