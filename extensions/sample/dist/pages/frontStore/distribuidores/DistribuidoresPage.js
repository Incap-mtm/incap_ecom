...
export default function DistribuidoresPage({ setting }) {
    ...
    // Initialize map
    useEffect(()=>{
        if (!mapReady || !mapRef.current || !apiKey || !window.google?.maps) return;
        ...
        Object.entries(byCity).forEach(([city, dists])=>{
            ...
            marker.addListener('click', ()=>{
                setActiveCity((prev)=>{
                    ...
                    if (next) {
                        gMapRef.current.panTo({
                            lat: first.lat,
                            lng: first.lng
                        });
                        gMapRef.current.setZoom(11);
                    } else {
                        gMapRef.current.setCenter({
                            lat: 4.5709,
                            lng: -74.2973
                        });
    ...
    return /*#__PURE__*/ React.createElement("div", {
      ...
      `), /*#__PURE__*/ React.createElement("div", {
    ...
    }, "Red de Distribución Nacional"), /*#__PURE__*/ React.createElement("h1", {
        style: {
    ...
    }, loaded ? `${data.length} distribuidores autorizados en Colombia` : 'Cargando...')), /*#__PURE__*/ React.createElement("div", {
        style: {
            display: 'flex',
            flex: 1,
            minHeight: '680px'
    ...
    }, filtered.length, " distribuidor", filtered.length !== 1 ? 'es' : ''), (search || region || industria) && /*#__PURE__*/ React.createElement("button", {
        ...
        return /*#__PURE__*/ React.createElement("button", {
            ...
            cy: "4.5",
            r: "4.5",
            fill: isActive ? '#2A4899' : '#cbd5e1'
        }), /*#__PURE__*/ React.createElement("polygon", {
            points: "2.5,7.5 6.5,7.5 4.5,12",
            fill: isActive ? '#2A4899' : '#cbd5e1'
        })), /*#__PURE__*/ React.createElement("span", {
            style: {
                fontSize: '12px',
                fontWeight: 800,
                color: isActive ? '#2A4899' : '#374151',
                textTransform: 'uppercase',
    ...
    }), loaded && filtered.length === 0 && /*#__PURE__*/ React.createElement("div", {
        style: {
            padding: '48px 24px',
            textAlign: 'center',
            color: '#94a3b8'
    ...
    }, "Intenta con otro filtro")))), /*#__PURE__*/ React.createElement("div", {
        style: {
            flex: 1,
            position: 'relative',
            minHeight: '680px'
    ...
    }), mapReady && !apiKey && /*#__PURE__*/ React.createElement("div", {
        style: {
            position: 'absolute',
            inset: 0,
            display: 'flex',
    ...
    }, "Mapa no configurado"), /*#__PURE__*/ React.createElement("div", {
        style: {
            fontSize: '12px',
            color: '#64748b'
        }
    }, "Agrega GOOGLE_MAPS_API_KEY al servidor")), activeCity && activeCityData && /*#__PURE__*/ React.createElement("div", {
        style: {
            position: 'absolute',
            top: '12px',
            right: '12px',
        ...
        }, LABEL_INDUSTRIA[d.industria] || d.industria || 'Comercio'), /*#__PURE__*/ React.createElement("div", {
            style: {
                fontSize: '11px',
                color: '#64748b',
                lineHeight: 1.5,
        ...
        }, d.direccion), d.telefono && /*#__PURE__*/ React.createElement("a", {
            href: `tel:${d.telefono}`,
            style: {
                fontSize: '11px',
                color: '#2A4899',
        ...
        }, "📞 ", d.telefono)))))), mapReady && apiKey && !activeCity && loaded && /*#__PURE__*/ React.createElement("div", {
        style: {
            position: 'absolute',
            bottom: '16px',
            left: '50%',
