    ...
    return (React.createElement(React.Fragment, null,
      ...
      `),
        React.createElement("div", { style: {
            ...
            React.createElement("img", { src: "/images/sections/Fallas_De_Pegue_contacto.png", alt: "", style: { width: '100%', height: 'auto', display: 'block', borderRadius: '12px' } })),
        React.createElement("div", { style: { textAlign: 'center' } },
            React.createElement("svg", { viewBox: "0 0 231.9 68.2", style: { height: '48px', width: 'auto', marginBottom: '0.75rem' } },
            ...
            React.createElement("div", { style: { color: 'rgba(255,255,255,0.45)', fontSize: '10px', fontWeight: 700, letterSpacing: '0.35em', textTransform: 'uppercase' } }, "Panel de Administraci\u00F3n"))));
}
export const layout = {
    areaId: 'content',
    sortOrder: 0
};
//# sourceMappingURL=LoginBranding.js.map